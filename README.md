# Hey folks! I'm Raviteja 👋  

<!-- Optional: Add a cool waving gif here -->
<!-- <img src="wave.gif" width="80" /> -->

<!-- Optional: Typing SVG -->
<!--
<img src="https://readme-typing-svg.herokuapp.com?size=24&color=36BCF7&lines=Data+Engineer;Big+Data+%7C+PySpark+%7C+AWS;Building+reliable+data+platforms" />
-->
...
- **Data Engineering / Big Data:**  
  - PySpark, Spark SQL  
  - Apache Iceberg / Delta concepts  
  - Hadoop ecosystem basics (HDFS, Hive)  
- **Data Science / Analytics:**  
  - Pandas, NumPy  
  - scikit-learn (for basic ML & feature engineering)  
  - Visualization: Matplotlib, Seaborn, Power BI / Tableau (if applicable)  

### 🧰 Other Tools & Platforms

- **Version Control:** Git, GitHub  
- **OS:** Linux, macOS/Windows for dev  
- **IDEs:** VS Code, PyCharm, Databricks Notebooks, Jupyter  

---

## 📌 What I usually work on

- Building **robust ETL/ELT pipelines** from relational DBs, SFTP feeds, and APIs  
...
🚀 **Always open to interesting discussions on data platforms, architecture, and performance tuning.  
Feel free to reach out on LinkedIn or explore my repos!**
